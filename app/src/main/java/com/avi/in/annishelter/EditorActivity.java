...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uri = received.getData();
        if (uri != null) {
            getSupportActionBar().setTitle(R.string.editor_activity_update_pet);

            getLoaderManager().initLoader(LOADER_ID, null, this);
        } else {
            getSupportActionBar().setTitle(R.string.editor_activity_add_new_pet);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.gender_male))) {
                        mGender = PetEntry.GENDER_MALE; // Male , mGender =1
                    } else if (selection.equals(getString(R.string.gender_female))) {
                        mGender = PetEntry.GENDER_FEMALE; // Female , nGender = 2
                    } else {
                        mGender = PetEntry.GENDER_UNKNOWN; // Unknown , mGender = 0
                    }
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                savePet();
                //Return to our Catalog Activity
                finish();
                return true;
    ...
    //Takes the data entered by user and saves to db
    private void savePet() {
        ...
        if (uri != null) {
            ...
            Log.v("Editor Activity ", "Row updated : " + updated);


            if (updated == 1) {
                Toast.makeText(this, mNameEditText.getText().toString().trim()
            ...
            Log.v("EditorActivity", "New Row Uri : " + newRowUri);


            if (newRowUri == null)
                Toast.makeText(this, R.string.Error_Toast, Toast.LENGTH_SHORT).show();
            else
                Toast.makeText(this, R.string.Pet_Saved_Toast, Toast.LENGTH_SHORT).show();
        }
    }
...
// the view, and we change the mPetHasChanged boolean to true.
    ...
    private void deletePet() {
        ...
        if (rowDeleted == 1) {
            ...
            Log.v("Editor Activity", "Row Successfully deleted");

            Toast.makeText(this, mNameEditText.getText().toString().trim() + " Deleted", Toast.LENGTH_SHORT).show();
