...
import com.avi.in.annishelter.data.PetContract;
...
public class PetCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView petNameView = view.findViewById(R.id.Pet_Name_TextView);
        TextView summaryView = view.findViewById(R.id.Summary_TextView);
